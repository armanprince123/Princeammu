...
def o():
    ...
    if None == '3':
        ...
        os.system('xdg-open https://github.com/KgPRINCE')
...
\033[1;96.
 ...
 \033[1;32m|     \033[1;33m[✓] CREATED BY\33[0;m   :  \033[1;33mPRINCE   \033[1;92m|

 \033[1;32m|     \033[1;32m[✓] FACEBOK      : \033[1;34m PRINCE                \033[1;92m|

 \033[1;32m|     \033[1;35m[✓] GITHUB       :  \033[1;35m PRINCE               \033[1;92m|
...
def i():
    ...
    print('IDS SAVED IN PRINCE.txt, PRINCE.txt')
    ...
    try:
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print('\33[1;34mPRINCE-CP ] '+cid+ ' | ' +ps+           '  \33[0;97m')

                open('/sdcard/PRINCE-CP.txt', 'a').write( cid+' | '+ps+' \n')
        ...
        sys.stdout.write('\r%s[PRINCE] \033[1;35m[%s/%s] \033[1;32m[OK-%s] \033[1;34m[CP-%s] \r'%(H,loop,tl,len(oks),len(cps))),
